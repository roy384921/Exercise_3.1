...
def train(config):    
    ...
    Pilot_file_name = 'Pilot_TaskD_'+str(P)+'.txt'
    ...
    with tf.Session(config=config_GPU) as sess:
        ...
        for epoch in range(training_epochs):
            ...
            if epoch % display_step == 0:
                ...
                input_labels_test = []
                test_number = 500                  
                if epoch > 0 and epoch % test_step == 0:
                    print("Big Test Set ")
                    test_number = 10000
                ...
                print("BER on test set ", BER_tensor.eval({X:batch_x}))                     
                
            if epoch > 0 and epoch % model_saving_step == 0:
